module.exports = function(grunt) {
	...
	grunt.initConfig({
		...
		concat: {
			...
			js_base: {
				//src: ['app/js/app.js', 'app/js/controllers.js', 'app/js/startup.js', 'app/js/utils.js', 'app/js/routes.js', 'app/js/services.js'],
				src: ['app/js/*.js'],
		...
		jshint: {
			...
			//pre_base: ['app/js/app.js', 'app/js/controllers.js', 'app/js/startup.js', 'app/js/utils.js', 'app/js/routes.js', 'app/js/services.js'],
			pre_base: ['app/js/*.js'],
			//pre_extras: ['app/js/app.js', 'app/js/controllers.js', 'app/js/startup.js', 'app/js/utils.js', 'app/js/routes.js', 'app/js/services.js'],
